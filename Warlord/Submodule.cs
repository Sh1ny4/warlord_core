...
namespace Warlord
{
    public class Submodule : MBSubModuleBase
    {
        protected override void OnSubModuleLoad()
        {
            ...
            Module.CurrentModule.AddInitialStateOption(new InitialStateOption("SandBoxNewGame", new TextObject("{=!}Start a New Game", null), 1, delegate () { MBGameManager.StartNewGame(new SandBoxGameManager()); }, () => new ValueTuple<bool, TextObject>(false, TextObject.Empty), _sandBoxAchievementsHint));
            Module.CurrentModule.AddInitialStateOption(new InitialStateOption("CampaignResumeGame", new TextObject("{=!}Load Game", null), 2, delegate () { ScreenManager.PushScreen(SandBoxViewCreator.CreateSaveLoadScreen(false));}, () => this.IsSavedGamesDisabled(), null));
